...
2. Verify `configs/pulse.toml`, `configs/models.toml`, `configs/topics/creative_ai.toml` exist and parse.
3. Run `pulse init` to create `./data/pulse.sqlite`, apply migrations, and create the LanceDB directory.
...
7. Start `pulse server` and verify the UI at `http://127.0.0.1:7878` returns 200.
8. Delete this file.
